...
/////////////////////////////////////////////
  ...
  typedef struct CAN_message_t {
      long unsigned int id = 0;          // can identifier
  ...
  // Define WAS message ID to match from bus
  ...
  void loop()
  {
      ...
      //get steering position EDIT IF CLAUSE TO J1939 WAS
      if (!useJ1939WAS){       
    ...
    //EDIT FOR J1939 WAS STARTS
    //Read steering angle from WAS
    if(useJ1939WAS)
    {
      readFromBus(wasMessage);
      readJ1939WAS(wasMessage);
    }
    //EDIT FOR J1939 WAS ENDS
  ...
  void writeToBus(CAN_message_t &msg){
    CAN.sendMsgBuf(msg.id, msg.flags.extended, msg.len, msg.buf);
  }
